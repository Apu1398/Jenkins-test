...
module.exports = __webpack_require__(/*! C:\Users\jp139\Desktop\TEC\VIII semestre\SOA\jenkins-test\Jenkins-test\webapp\src\main.ts */"zUnb");
...
class AppComponent {
    constructor(http) {
        this.http = http;
        this.title = 'simple-web';
    }
    ngOnInit() {
        const body = { "username": "cubero2112", "password": "1234" };
        this.http.post("http://localhost:8080/api/auth/signin", body).subscribe(data => console.log(data));
    }
}
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 3, vars: 0, template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "Hola Mundo ahora otra vez final recompilado");
